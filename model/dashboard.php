...
//---------------------------------------------------
	...
	function init()
	{
		...
		" WHERE    projects.Archive=0 ".
		"     AND (tasks.IDTasksStatus=1 or tasks.IDTasksStatus is null)".
		" GROUP BY ".
		"	projects.IDproject,".
		"	projects.Name,".
		"	projects.color".
...
//---------------------------------------------------
	...
	function ListProject()
	{
         ...
         while( $row = mysqli_fetch_assoc($result) ){ 
          echo '<option style="color:'.$row['Color'].'" value="'.$row['IDProject'].'">'.$row['Name'].'</option>';
        } 
...
//---------------------------------------------------
	...
	function ListTasksPriority()
	{
         ...
         while( $row = mysqli_fetch_assoc($result) ){ 
          echo '<option style="color:'.$row['Color'].'" value="'.$row['IDTasksPriority'].'">'.$row['Name'].'</option>';
        } 
